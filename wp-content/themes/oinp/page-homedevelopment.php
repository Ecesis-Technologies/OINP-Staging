 ...
 * Template Name: OINP Home Rewamp
...
.main .banner .banner-inner .banner-item .container .h1-titles{max-width:380px;}
@keyframes blink {
  0% { opacity: 1; }
  50% { opacity: 0; }
  100% { opacity: 1; }
...
.main .banner .banner-inner .banner-item .container .banner-learn.color-blue::after{box-shadow: inset -320px 0px 0px #004ac1;}
.main .start-business .business-in .business-form.is-flipped .busines-form-box:first-of-type {
    pointer-events: none;
    z-index: 0;
}

.main .start-business .business-in .business-form .face-back {
    z-index:200;
}
      ...
      <div class="banner-inner ">
        ...
        <div class="banner-item">
          ...
          <div class="banner-images">
            ...
            <img src="<?php echo $desktop_image['url']; ?>" class="desk-banner" >

            <img src="<?php echo $mobile_image['url']; ?>" class="mobile-banner">
          ...
          <div class="container">
            ...
            <a href="<?php _ol(get_sub_field('link')); ?>" target="_blank" class="banner-learn color-blue">
             ...
             <a id="explore-business-opportunities" href="https://futureisontario.com/explore-business-opportunities/"  class="banner-learn color-blue" style="width:320px;">
	...
	<div class="location-section-container">
      ...
      <div class="location-title">
				...
				<div class="location-description">
					<p>
					If you are an entrepreneur thinking about immigrating to Ontario, Canada, the OINP Entrepreneur Success Initiative is here to help. We will make it easy for you every step of the way.</p>   
					<p>Please click on the <span style="color:#1BBD83">green dots </span> to know more about the business opportunities in each city.</p>
				</div>  
    </div>
		<!-- </div> -->
...
<section class="start-business"  id="top">
  ...
  <div class="start-business-container">
    ...
    <div class="business-in">
      ...
      <form action="<?php echo site_url(); ?>/#top" method="post" style="width:100%">
...
const map = new mapboxgl.Map({
	...
	style:'mapbox://styles/sivaecesis/clp0yn715019o01pr9i94c4yb',    
    center: [-89.259796,48.506414],
    zoom: 4,
    maxZoom: 10,
    minZoom: 3.0
});
...
function select(data){
  setTimeout(function() {
    var industyElements = document.querySelectorAll('.be_cnt ul li a');
    if (industyElements.length > 0) {
        industyElements.forEach(function(element) {
            element.classList.add('selectedcity');
        });
    }
        var myLinkElements = document.querySelectorAll('.selectedcity');
        if (myLinkElements.length > 0) {
          myLinkElements.forEach(function(element) {
            element.href = 'http://localhost/OINP-Staging/explore-business-opportunities/?city='+ encodeURIComponent(data)+'#listing';
        });
    }      
    }, 500);
}
