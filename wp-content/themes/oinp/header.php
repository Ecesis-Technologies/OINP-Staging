...
<body class="<?php if (get_the_title() != 'Home'){ echo 'inner-pages ';} if (get_the_title() != 'Home' && get_the_title() != 'FAQs'){ echo ' about ';}  echo strtolower(get_the_title()); ?> <?php if(WPGlobus::Config()->language=='fr'){ echo 'french';} ?>">

<div class="main" id="main">

    <!-- template header -->

    <header id="header" class="<?php if(WPGlobus::Config()->language=='fr'){ echo 'french';} ?>">
