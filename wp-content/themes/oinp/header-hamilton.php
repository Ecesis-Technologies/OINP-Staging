...
<title>OINP</title>
 ...
 <link rel="shortcut icon" type="image/png" href="./<?php echo get_template_directory_uri(); ?>/assets/images/fav-icon.png"/>
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/assets/css/theme2.css" rel="stylesheet" type="text/css">
...
<body class="<?php if (get_the_title() != 'Home'){ echo 'inner-pages ';} if (get_the_title() != 'Home' && get_the_title() != 'FAQs'){ echo ' about ';}  echo strtolower(get_the_title()); ?> theme2">
    ...
    <header id="header">
        ...
        <div class="container">
            ...
            <div class="top-nav">
                ...
                <?php //wp_nav_menu( array('theme_location' => 'hamilton1', 'container' => '','items_wrap' => '<ul>%3$s</ul>' ) ); ?>
                
				<ul>
                <li id="menu-item-1" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1">
                <a href="#introsect">About <?php the_title(); ?></a>
                </li>
				<li id="menu-item-2" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2">
                <a href="#supportservicesect"><?php the_title(); ?> Support Services</a>
                </li>
				<li id="menu-item-3" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-3">
                <a href="#keysectorssect">Key Sectors</a>
                </li>
				</ul>
                ...
                <?php /*?><div class="language" style="display:none;">
