...
function showDiv(type)
{
  if(type == 1)
  {
    $("#stage_1").addClass("you-select");
    $("#stage_2").removeClass("you-select");
    $("#sstage_2").css('style')
  }
  else if(type == 2){
    $("#stage_2").addClass("you-select");
    $("#stage_1").removeClass("you-select");
    $("#sstage_2").css("display","block");
    $("#sstage_1").css("display","none");
  }
}

function showDiv1(type)
{
  if(type == 1)
  {
    $("#international").addClass("you-select");
    $("#domestic").removeClass("you-select");
    $("#sdomestic").css('style')
  }
  else if(type == 2){
    $("#domestic").addClass("you-select");
    $("#international").removeClass("you-select");
    $("#sdomestic").css("display","block");
    $("#sinternational").css("display","none");
  }
}
