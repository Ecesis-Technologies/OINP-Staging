 ...
 * @author    WPGlobus
 * @category  Extension
 * @copyright Copyright 2014-2023 The WPGlobus Team: Alex Gor (alexgff) and Gregory Karpinsky (tivnet)
 */
 ...
 * @since 1.4.0
 */
require_once dirname( __FILE__ ) . '/includes/wpglobus-plus-functions.php';
...
function wpglobus_plus_load() {
	...
	define( 'WPGLOBUS_PLUS_VERSION', '1.10.0' );
	/**
	 * @since 1.1.55
	 */
	 ...
	 * @since 1.5.0
	 */
	define( 'WPGLOBUS_PLUS_WPGLOBEDITOR_PHP_VERSION', '7.3.0' );
